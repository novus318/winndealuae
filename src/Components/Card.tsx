...
const Card = () => {
  ...
  return (
    <div
      className="bg-white text-[#282828] py-16"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-4xl font-extrabold mb-4 tool" ref={animateEntrance}>
            At Winndeal Solutions
          </h2>
          <p className="text-xl text-gray-500" ref={animateEntrance}>
        ...
        <div className="mt-12 grid grid-cols-1 gap-12 md:grid-cols-3"
         ref={(el) => {
          ...
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 bg-[#fd0] rounded-full flex items-center justify-center" ref={animateEntrance}>
              <FaCheckCircle className="text-4xl text-white" />
            </div>
            <h3 className="mt-4 text-2xl font-semibold tool" ref={animateTextEntrance}>
              Our Values
            </h3>
            <p className="mt-2 text-lg text-gray-500 text-center" ref={animateTextEntrance}>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-2 text-lg text-gray-500 text-center" ref={animateTextEntrance}>
              Our team of technicians is passionate about technology and always strives to stay at the forefront of the industry. With their expertise, we are able to deliver innovative solutions to our customers.
            </p>
          </div>
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 bg-[#fd0] rounded-full flex items-center justify-center" ref={animateEntrance}>
